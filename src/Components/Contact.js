    ...
    <div className='contact'>
        ...
        <div className="contact-container">
                <div className={`env ${slideOut ? 'message-sent-full-env' : ''}`}>
                    ...
                    src={require(`../images/open-envelope-nocover.png`)} alt="" />
                    <img className={`env-back ${messageSent ? 'message-sent' : ''}`} src={require(`../images/back-of-env.png`)} alt="" />
                    <img className={`env-cover ${messageSent ? 'message-sent-cover' : ''}`} src={require(`../images/envelope-cover.png`)} alt="" />
                </div>
